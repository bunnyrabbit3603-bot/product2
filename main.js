...
const METRIC_HELP_TEXTS = {
  PER: "주가를 주당순이익(EPS)으로 나눈 값입니다. 보통 낮을수록 이익 대비 주가가 덜 비싸다고 봅니다.",
  ...
  "추정PER": "앞으로 예상되는 이익 기준 PER입니다. 미국 종목은 제공원에 값이 없으면 목표가 기준 환산값으로 보여줍니다.",
  "추정EPS": "앞으로 예상되는 EPS입니다. 미국 종목은 제공원에 값이 없으면 목표가/현재지표 기반 환산값으로 보여줍니다.",
  ...
  "영업활동 현금흐름": "본업으로 실제 들어온 현금입니다. 꾸준히 +면 재무적으로 안정적인 편입니다.",
  "투자활동 현금흐름": "설비·신사업 등에 쓴 돈 흐름입니다. -가 커도 성장 투자일 수 있습니다.",
  "재무활동 현금흐름": "차입·상환·배당·자사주 같은 자금 조달/환원 흐름입니다.",
  "거래량": "거래된 주식 수입니다. 많을수록 관심과 유동성이 높은 편입니다.",
  "주당배당금": "주식 1주당 받는 배당금입니다.",
  "배당일": "배당금이 실제 지급되는 날짜입니다.",
  "배당락일": "이 날짜 이후 매수하면 이번 배당을 못 받는 기준일입니다.",
  "현재가": "가장 최근 체결 가격입니다.",
  "시가": "오늘(또는 해당 봉) 시작 가격입니다.",
  "고가": "오늘(또는 해당 봉) 가장 높았던 가격입니다.",
  "저가": "오늘(또는 해당 봉) 가장 낮았던 가격입니다.",
  "52W 위치": "현재가의 1년 구간 위치입니다. 높을수록 고점권, 낮을수록 저점권입니다.",
